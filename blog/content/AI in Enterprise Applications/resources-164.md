...
• [Bubble](https://x.com/bubble) - Platform for building web applications without code

• [EarningsVibeAI](https://x.com/earningsvibeAI) - AI-powered financial analysis platform

![Image](https://pbs.twimg.com/media/HEILGyraIAAzo5I?format=jpg&name=small)

---
### ✨ AI Applications - Accessible Financial Analysis
...
• [EarningsVibeAI](https://earningsvibe.ai) - Platform for AI-powered financial insights

![Image](https://pbs.twimg.com/media/HEILNbLWAAAb8_Z?format=jpg&name=small)

---
### 💡 AI Productivity - Performance Optimization
...
• [LittlebirdAI](https://x.com/LittlebirdAI) - AI tool for productivity

• [Scott Belsky's Insight](https://x.com/scottbelsky/status/2036125665616076863) - Discussion on future of productivity tech
...
• [LittlebirdAI](https://x.com/LittlebirdAI) - Tool for frictionless work management

• [Gokul Rajaram's Endorsement](https://x.com/gokulr/status/2036130472951152913) - Perspective on LittlebirdAI's value
...
• [Supernormal.com](https://supernormal.com) - Desktop app with multilingual support
...
• [Sensor Tower Blog](https://www.sensortower.com/blog/soda-brands-in-flux-coca-cola-pepsi-olipop-poppi) - Blog post on soda brand analysis

• [Sensor Tower](https://x.com/SensorTower) - Market intelligence and insights

![Image](https://pbs.twimg.com/media/HEG9M0LXYAAndPL?format=jpg&name=small)

---
### 🤖 AI in Software Development - Limitations of Autonomous Coding Agents
...
• [Research Paper](https://arxiv.org/pdf/2403.07684) - Paper discussing limitations of AI coding agents

• [Code Repository](https://github.com/SF-Research/Esoteria) - Associated code for the research

• [Dataset](https://huggingface.co/datasets/SF-Research/Esoteria) - Dataset used in the study

• [SF Research](https://x.com/SFResearch) - Research group behind the study
