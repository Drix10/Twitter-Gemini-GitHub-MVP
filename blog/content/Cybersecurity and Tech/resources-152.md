...
• [Azure-Sentinel GitHub](https://github.com/Azure/Azure-Sentinel) - Public repository for Microsoft Sentinel security solutions
...
• [AdGuard Lifetime Deal](https://www.bleepingcomputer.com/offer/deals/kill-ads-trackers-for-just-15-97-in-this-adguard-lifetime-deal/) - Acquire a lifetime license for AdGuard functionality
...
![Image](https://pbs.twimg.com/media/HGe-JXjaEAAi21N?format=jpg&name=small)

![Image](https://pbs.twimg.com/media/HGe-JWubIAEFFXq?format=jpg&name=small)
...
• [CISA KEV Catalog](https://www.cisa.gov/known-exploited-vulnerabilities-catalog) - Official catalog of known exploited vulnerabilities

![Image](https://pbs.twimg.com/media/HGr_XWOWcAEEOfn?format=jpg&name=small)
...
• [Pack2TheRoot Flaw Details](https://www.bleepingcomputer.com/news/security/new-pack2theroot-flaw-gives-hackers-root-linux-access/) - Information on the new Linux root access vulnerability
...
![Image](https://pbs.twimg.com/media/HGkU4mMXYAAsXoQ?format=jpg&name=small)

![Image](https://pbs.twimg.com/media/HGkU5gJXEAEvo5p?format=png&name=360x360)

![Image](https://pbs.twimg.com/media/HGkU6Z8XUAA0sIp?format=jpg&name=360x360)
...
• [Red Balloon Rising Malware Analysis](https://www.huntress.com/blog/red-balloon-rising-new-windows-malware-analysis-from-huntress) - Detailed analysis of new Windows malware
...
• [GoGra Linux Backdoor Report](https://www.bleepingcomputer.com/news/security/new-linux-gogra-backdoor-hides-behind-outlook-mailboxes/) - Detailed analysis of the GoGra Linux backdoor
