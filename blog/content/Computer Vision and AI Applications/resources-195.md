...
• [Shoubin Song](https://x.com/shoubin621) - Profile of a presenter or attendee.

• [Mohit Bansal](https://x.com/mohitban47) - Profile of a presenter or attendee.

• [ACL2026 Hashtag](https://x.com/hashtag/ACL2026?src=hashtag_click) - Access more content related to the conference.

![Image](https://pbs.twimg.com/media/HMUG35DaMAAO27T?format=jpg&name=small)

![Image](https://pbs.twimg.com/media/HL_R9fwW0AA50eE?format=jpg&name=240x240)
...
• [Paper: DataComp-series](https://arxiv.org/abs/2606.28551) - Research on VLM data curation with experiments.

• [Ferjad Naeem](https://x.com/ferjadnaeem) - Profile of a researcher.

• [Vishaal Uraon](https://x.com/vishaal_urao) - Profile of a researcher.

![Image](https://pbs.twimg.com/media/HMPiNjmacAAwL9G?format=jpg&name=small)
...
• [Almorgand](https://x.com/Almorgand) - Profile of the system operator.

![Image](https://pbs.twimg.com/media/HMUMtCoWwAA-OsV?format=jpg&name=small)
...
• [Gurish Sharma](https://x.com/gurishsharma) - Profile of the software engineer.

• [Vercel](https://vercel.com) - Frontend cloud platform for developers.

• [Supabase](https://supabase.com) - Open source Firebase alternative for backend services.

• [WorkOS](https://workos.com) - Enterprise features like SSO and SCIM for applications.
...
• [Qualcomm](https://x.com/Qualcomm) - Official Qualcomm Twitter profile.

• [Snapdragon](https://x.com/Snapdragon) - Official Snapdragon Twitter profile.

• [QCOM Investor Day](https://www.qualcomm.com/company/events/investor-day) - Information on Qualcomm's investor event.

• [QCOMInvestorDay Hashtag](https://x.com/hashtag/QCOMInvestorDay?src=hashtag_click) - Access more content related to the event.
...
• [Paper: VOCA](https://arxiv.org/abs/2607.00189) - Research on visual odometry with codec awareness.

• [Zhenjun Zhao](https://x.com/zhenjun_zhao) - Profile of a researcher.

• [Mateo de Mayo](https://x.com/mateodemayo) - Profile of a researcher.

![Image](https://pbs.twimg.com/media/HMRqFu1bQAA4pYD?format=jpg&name=360x360)

![Image](https://pbs.twimg.com/media/HMRqFu1agAA2ufK?format=png&name=360x360)

![Image](https://pbs.twimg.com/media/HMRqFu2bMAAcCO_?format=png&name=360x360)

![Image](https://pbs.twimg.com/media/HMRqL6DaEAAAiMy?format=png&name=360x360)
...
• [Paper: LIST3R](https://arxiv.org/abs/2607.00375) - Research on instance-aware 3D reconstruction.

• [Zhenjun Zhao](https://x.com/zhenjun_zhao) - Profile of a researcher.

![Image](https://pbs.twimg.com/media/HMRk82saoAAiNpa?format=jpg&name=900x900)

![Image](https://pbs.twimg.com/media/HMRlCDQaoAAK6Yr?format=png&name=360x360)

![Image](https://pbs.twimg.com/media/HMRlKLnagAA9ju6?format=png&name=360x360)
...
• [Paper: EPO](https://arxiv.org/abs/2607.00579) - Research on edge-based pose optimization for 3D models.

• [Zhenjun Zhao](https://x.com/zhenjun_zhao) - Profile of a researcher.

![Image](https://pbs.twimg.com/media/HMSZkOKbYAALp3s?format=jpg&name=360x360)

![Image](https://pbs.twimg.com/media/HMSZkOKa0AE4gw7?format=png&name=360x360)

![Image](https://pbs.twimg.com/media/HMSZkOPagAED5H_?format=png&name=360x360)

![Image](https://pbs.twimg.com/media/HMSZkOKb0AA942o?format=png&name=small)
...
• [Paper: Model Memorization](https://arxiv.org/abs/2505.24832) - Research on AI model learning dynamics.

• [Paper: Generalization in ML](https://arxiv.org/abs/2505.17638) - Study on memorization in machine learning.

• [Gabriele Berton](https://x.com/gabriberton) - Profile of the author discussing AI learning dynamics.
