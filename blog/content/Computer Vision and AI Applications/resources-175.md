...
• [Mr. Doob (Three.js)](https://x.com/mrdoob) - Creator of influential 3D web graphics library.

• [Drift Car Simulation](https://raw.githack.com/gitdolucas/Staff/main/car.html) - Live browser-based 3D car simulation.

• [Ajd Davison's Cycling Game](http://doc.ic.ac.uk/~ajd/Cycling/) - Example of a neuroevolution-based game.
...
![Image](https://pbs.twimg.com/media/HHjiknnXgAUL7VY?format=jpg&name=small)

---
### 🤖 AI - 3D Scene Generation with Agentic Frameworks
...
• [Scenethesis Paper](https://arxiv.org/pdf/2403.11183) - Research paper on 3D scene generation framework.

![Image](https://pbs.twimg.com/amplify_video_thumb/2051320156438114304/img/yezIKFMfSOaxiPEO.jpg)

---
### 🤖 AI - Robustness in 3D Scene Generation
...
• [DFlash Blog Post](https://cloud.google.com/blog/products/ai-machine-learning/diffusion-style-speculative-decoding-for-llm-inference) - Google Cloud blog explaining DFlash for LLM inference.
...
• [Axelera AI](https://x.com/AxeleraAI) - Company focusing on efficient AI inference solutions.

![Image](https://pbs.twimg.com/media/HHftPmFWQAAvjZU?format=jpg&name=small)

---
### 💡 Professional Communication - Social Media Engagement
...
![Image](https://pbs.twimg.com/media/HHfs3rBX0AA2QYx?format=jpg&name=small)

![Image](https://pbs.twimg.com/media/HHfSDQLWoAA_QPG?format=png&name=240x240)

---
### 💡 Online Communities - Content Trends on Lobsters
...
![Image](https://pbs.twimg.com/media/HHesItGaQAAU3Oa?format=jpg&name=small)

![Image](https://pbs.twimg.com/media/HHcFhKcaEAAts9_?format=jpg&name=240x240)
